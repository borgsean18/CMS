 ...
 */
add_action('widgets_init', 'shadowfiend_register_carousel_module');

function shadowfiend_register_carousel_module(){
	register_widget('shadowfiend_carousel');
}
 ...
 *
 */ 
class shadowfiend_carousel extends WP_Widget {
	...
	function __construct(){
		...
		/* Create the widget. */
		parent::__construct('shadowfiend_carousel', esc_html__('*shadowfiend: Module Carousel', 'zalora'), $widget_ops);
	}
	...
	function widget($args, $instance){
        ...
        ?>			
            <div class="shadowfiend-carousel-wrap flexslider clear-fix">            
				<ul class="slides">
