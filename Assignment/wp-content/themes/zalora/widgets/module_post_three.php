<?php
/**
 * Plugin Name: shadowfiend: Module Post Three
 ...
 */
add_action('widgets_init', 'shadowfiend_register_module_post_three');

function shadowfiend_register_module_post_three(){
	register_widget('shadowfiend_module_post_three');
}
 ...
 *
 */ 
class shadowfiend_module_post_three extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'module-post-three', 'description' => esc_html__('[Content module] Displays one main post and four sub posts below in content section', 'zalora'));
		
		/* Create the widget. */
		parent::__construct('shadowfiend_module_post_three', esc_html__('*shadowfiend: Module Posts Three', 'zalora'), $widget_ops);
	}
